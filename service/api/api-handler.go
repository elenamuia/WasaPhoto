...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.PUT("/users/:banninguser/banned/:banneduser", rt.wrap(rt.banUser))
	rt.router.DELETE("/users/:banninguser/banned/:banneduser", rt.wrap(rt.unbanUser))
	...
	rt.router.PUT("/users/:followinguser/followed/:followeduser", rt.wrap(rt.followUser))
	rt.router.DELETE("/users/:followinguser/followed/:followeduser", rt.wrap(rt.unfollowUser))
